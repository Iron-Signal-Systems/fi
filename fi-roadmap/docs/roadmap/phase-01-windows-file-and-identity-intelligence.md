...
| Local Windows identity | in-progress | Local users, groups, memberships, and related identity records are not yet implemented. |
| Active Directory identity | in-progress | Versioned directory identity collection through the intended gMSA boundary is not yet implemented. |
