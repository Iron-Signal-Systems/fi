...
var (
	ErrGovernedRootChangedDuringCollection = errors.New("governed root changed during collection")
	...
	ErrObjectIdentityMismatch              = errors.New("opened object does not match requested NTFS object identity")
	...
	ErrUnsupportedIdentityMethod           = errors.New("NTFS object identity method is not supported for OpenFileById")
	ErrUnsafePathForm                      = errors.New("path form is not authorized for direct NTFS collection")
	ErrWalkDirectoryChanged                = errors.New("directory identity changed before traversal")
)
