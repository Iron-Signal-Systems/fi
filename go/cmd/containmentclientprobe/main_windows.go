...
const (
	probeErrorPath  = `C:\ProgramData\FI\state\gate1-containment-error.txt`
	probeInputPath  = `C:\ProgramData\FI\state\gate1-containment-input.json`
	probeResultPath = `C:\ProgramData\FI\state\gate1-containment-result.json`
	probeVersion    = "fi-gate1-production-containment-client/1.0"
)
