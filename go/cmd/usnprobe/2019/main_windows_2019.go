...
const (
	probeVersion = "windows-server-2019-usn-characterization/0.2"
	serviceName  = "FIUSNProbe2019"

	probeInputPath  = `C:\FI-Test\usnprobe\input-2019.json`
	probeResultPath = `C:\FI-Test\usnprobe\usn-access-matrix-2019.json`
	probeErrorPath  = `C:\FI-Test\usnprobe\usn-access-matrix-2019-error.txt`
